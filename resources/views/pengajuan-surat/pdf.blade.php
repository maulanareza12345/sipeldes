...
<style>
        ...
        /* Judul Dokumen */
        .judul-block { text-align: center; margin-bottom: 12px; }
        .judul-surat { font-size: 12pt; font-weight: bold; text-transform: uppercase; text-decoration: underline; }
        .nomor-surat { font-size: 10pt; margin-top: 1px; }
...
@php
    ...
    // Determine which content partial to use
    $pdfTemplate = $pengajuan->jenisSurat->pdf_template ?? null;
    $contentView = 'pengajuan-surat.content.default';
    if ($pdfTemplate && view()->exists('pengajuan-surat.content.' . $pdfTemplate)) {
        $contentView = 'pengajuan-surat.content.' . $pdfTemplate;
    }
    ...
    // Ambil nama & jabatan tanda tangan
