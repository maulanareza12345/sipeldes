...
<head>
    ...
    <style>
        body { 
            ...
            position: relative;
            background-color: #0f172a; /* Warna dasar gelap yang konsisten */
        }
...
<div class="page">
    <div class="card">
        <div class="brand">
            ...
            <p>Setel password baru untuk akun admin.</p>
        </div>
...
<script>
    // LOGIKA INTERAKSI MOUSE TRAIL (KONSISTEN DENGAN HALAMAN LAIN)
    ...
    class Particle {
        constructor() {
            ...
            this.color = `hsl(${Math.random() * 40 + 190}, 100%, 70%)`; // Efek cyan-biru elektrik bawaan
            this.alpha = 1;
