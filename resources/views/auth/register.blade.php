...
<head>
    ...
    <title>Registrasi - Sistem Desa</title>
    <style>
        body { 
            margin: 0; 
            ...
            position: relative;
            background-color: #0f172a; /* Warna dasar gelap yang sama dengan login */
        }
...
<div class="page">
    <div class="card">
        <div class="brand">
            ...
            <p>Buat akun untuk mengelola data penduduk, surat, dan laporan.</p>
        </div>
...
<script>
    // LOGIKA INTERAKSI MOUSE TRAIL (KONSISTEN DENGAN HALAMAN LOGIN)
    ...
    class Particle {
        constructor() {
            ...
            this.color = `hsl(${Math.random() * 40 + 190}, 100%, 70%)`; // Gradasi cyan-biru elektrik
            this.alpha = 1;
